...
| Formula   |       a | crystal           |   predicted_a |    mp_a | % error vs Expt   | % error vs MP |
|:----------|--------:|:------------------|--------------:|--------:|:------------------|:--------------|
| C         | 3.567   | Diamond (FCC)     |       3.5718  | 3.57371 | 0.13%             | -0.05%        |
...
| NbC0.99   | 4.47    | Halite            |       4.50591 | 4.50617 | 0.80%             | -0.01%        |
